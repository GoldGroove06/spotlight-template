    ...
    return (
        ...
        <nav className={`  bg-[var(--rad-ui-color-gray-300)] lg:w-[90vw] h-24 flex flex-row  lg:items-center w-full lg:justify-center justify-end p-2 ml-2 mr-2 border border-l-gray-600 border-r-gray-600`}>
            ...
            <div className={`hidden lg:block flex flex-row space-x-6  text-slate-1000 rounded-full pl-4 pr-4 p-2  m-4 border border-gray-700 bg-slate-300  ${hidden ? " " : "translate-y-0 fixed top-2 z-50"}`}>
                <Link href="/about" className={`hover:text-teal-900 pb-3 ${pathname === "/about" ? "text-teal-900" : ""}`}>About</Link>
                <Link href="/articles" className={`hover:text-teal-900 pb-3 ${pathname === "/articles" ? "text-teal-900" : ""}`}>Articles</Link>
                <Link href="/projects" className={`hover:text-teal-900 pb-3 ${pathname === "/projects" ? "text-teal-900" : ""}`}>Projects</Link>
                <Link href="/speaking" className={`hover:text-teal-900 pb-3 ${pathname === "/speaking" ? "text-teal-900" : ""}`}>Speaking</Link>
                <Link href="/uses" className={`hover:text-teal-900 pb-3 ${pathname === "/uses" ? "text-teal-900" : ""}`}>Uses</Link>
            </div>


            <div className='block lg:hidden'>
                <Dialog.Root >
                    <Dialog.Trigger className={`lg:top-7 lg:right-[8vw] top-4 right-[10vh] mt-4 !rounded-full !pl-4 !pr-4 !p-5 border border-gray-700 !bg-slate-300 !text-slate-1000  ${hidden ? "lg:absolute  " : "translate-y-0 fixed top- z-50"}`}>
                        <>Menu</>
                    </Dialog.Trigger>
                    <Dialog.Portal>
                        <Dialog.Overlay />
